...
INCLUDE = [
    ...
    "core/__init__.py", "core/store.py", "core/sources.py", "core/manager.py", "core/tray.py", "core/version.py", "core/updater.py", "core/companion.py", "core/modpacks.py", "core/players.py", "assets/MCSMCompanion.jar",
